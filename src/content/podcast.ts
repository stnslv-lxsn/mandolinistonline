// Выпуски подкаста. Плееры живут на отдельной странице /podcast, на главной — только
// тема и кнопка. Название подкаста по просьбе Егора нигде не показывается
export const podcastHeading = 'Разговоры о решениях, команде и рынке';

export const podcast = [
  {
    slug: 'svobodnyy-vybor',
