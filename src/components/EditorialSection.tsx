...
// Фон раздела по его номеру: чем дальше раздел, тем светлее. Классы выписаны целиком,
// иначе Tailwind их не найдёт при сборке
...
export default function EditorialSection({ id, number, title, children, className = '' }: EditorialSectionProps) {
  return (
    // Фон на всю ширину окна, а сам раздел по-прежнему не шире 1400px
    <div className={tones[number] ?? ''}>
