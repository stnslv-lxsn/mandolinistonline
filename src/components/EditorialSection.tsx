...
export default function EditorialSection({ id, number, title, children, className = '' }: EditorialSectionProps) {
  return (
    <section id={id} className={`px-6 md:px-12 py-16 md:py-20 scroll-mt-8 max-w-[1400px] mx-auto border-t border-rule ${className}`}>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 xl:gap-16">
        ...
        <div className="xl:col-span-2 shrink-0">
          <div className="xl:sticky xl:top-32 flex items-center gap-4 text-xs font-bold uppercase tracking-[0.2em] text-muted mb-6 xl:mb-0">
