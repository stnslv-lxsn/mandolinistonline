 ...
 *
 * Сейчас первый экран показывает public/portrait.webp из версии Егора как есть, файлы
 * hero-desktop / hero-mobile на странице не используются. Картинка превью (OG) — отсюда.
 *
 ...
 * на хостинг лишним весом. Сейчас в assets/hero.jpg и hero-original.jpg — готовый
 * снимок от заказчика (27.09), скриптом не ретушировался. Раньше ретушь кожи делал
 * scripts/retouch-hero.py из assets/hero-original.jpg. Заменили фото — положите его
 * в hero-original.jpg, поправьте области лица и руки в retouch-hero.py, запустите
 * его, затем этот скрипт; кадр превью — OG.crop.
 */
